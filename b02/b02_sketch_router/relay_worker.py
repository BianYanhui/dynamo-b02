...
"""One process-sharded B02 raw ZMQ relay.
...
from b02_sketch_router.selective_signaling import SelectiveKVStateGateway
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="B02 process-sharded raw ZMQ relay")
...
async def _run(runtime: DistributedRuntime, args: argparse.Namespace) -> None:
    ...
    logger.info("B02 sharded relay started (workers=%s, ports=%s)", worker_ids, ports)
    ...
    try:
        ...
        try:
            ...
            pass
        logger.info("B02 sharded relay stopped (workers=%s)", worker_ids)
