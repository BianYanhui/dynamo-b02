...
Frozen field layout from B02 `experiments/design.md` §1.4:
...
Byte sizes are the B02 headline measurement (Sketch ~= Coarse << Rich),
...
from b02_sketch_router.workflow_state import TOOL_STATUS_BITS, WorkflowRecord
...
def build_sketch(
    ...
    """Sketch view: packed dispatching signal (B02 §1.4 frozen fields)."""
