...
"""Sketch-Dispatch policy (B02 `experiments/design.md` §1.2).
...
owns the workflow's most recent step), exactly as in B02's Rich/Sketch
...
class SketchDispatchPolicy:
    ...
    def decide(
        ...
        for inst in candidate_instances:
            ...
            if inst == owner:
                # B02 §1.2: affinity_score = -(# of R's recent steps on I);
