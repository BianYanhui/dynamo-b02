#!/usr/bin/env python3
"""Fair replay benchmark for native Dynamo versus Worker-local B02.
...
class BlockStored:
    """Minimal vLLM-compatible event shape used by the B02 selector."""
...
def main() -> None:
    ...
    parser.add_argument("--modes", default="native,b02")
    ...
    parser.add_argument("--out", default="/tmp/b02_native_replay.json")
