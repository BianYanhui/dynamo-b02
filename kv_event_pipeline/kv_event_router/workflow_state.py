...
"""KV event workflow state table.

Port of the Motivation Experiment dispatcher's workflow table
(`experiments/design.md` §11) into a Dynamo router component.
...
class WorkflowRecord:
    """One agentic workflow as the dispatcher sees it (Selective signaling §11 fields)."""
...
class WorkflowTable:
    ...
    def affinity_hot_counts(self, n_instances: int) -> list[int]:
        ...
        (selective-signaling design.md §1.4 sketch field)."""
