...
"""Unit tests for KV event state view builders (pure Python, no Dynamo runtime)."""
...
from kv_event_router.state_views import build_coarse, build_rich, build_sketch
from kv_event_router.workflow_state import WorkflowRecord, WorkflowTable
...
def test_policy_owner_pin_and_overload():
    from kv_event_router.policy import SketchDispatchPolicy, SketchPolicyConfig
    table = WorkflowTable()
