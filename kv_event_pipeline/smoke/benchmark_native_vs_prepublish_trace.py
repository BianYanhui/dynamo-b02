...
The native and KV event modes receive the same per-publisher EventBatch sequence.
Native forwards each original payload unchanged; KV event decodes each batch,
...
def main() -> None:
    ...
    ap.add_argument("--modes", default="native,prepublish")
