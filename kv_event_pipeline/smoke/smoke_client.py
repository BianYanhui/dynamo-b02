...
"""KV event sketch-router smoke client: agentic workload with session headers.
...
async def main() -> None:
    ...
    ap.add_argument("--model", default="qwen-kv")
    ...
    ap.add_argument("--out", default="/tmp/kv_event_state_logs/smoke_results.jsonl")
    args = ap.parse_args()
