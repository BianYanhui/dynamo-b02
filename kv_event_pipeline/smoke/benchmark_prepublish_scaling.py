#!/usr/bin/env python3
"""Stress the raw KV-event ZMQ path and the Worker-local KV event selector.
...
def run_case(
    ...
    process_mode = mode != "prepublish-thread"
    ...
    try:
        ...
        producer_mode = "native" if mode == "native" else "selective"
...
def main() -> None:
    ...
    parser.add_argument("--modes", default="native,prepublish-thread,prepublish-process")
    ...
    parser.add_argument("--out", default="/tmp/kv_event_prepublish_scaling.json")
